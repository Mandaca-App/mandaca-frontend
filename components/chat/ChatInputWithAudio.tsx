...
export const ChatInputWithAudio = ({
  onSendMessage,
  isLoading = false,
      ...
      <View className="flex flex-row items-center justify-center gap-2.5 px-4 pt-3">
        ...
        <Animated.View style={animatedStyle}>
          ...
          >
            {isTranscribing ? (
              <ActivityIndicator
                size="small"
                color={theme.sendButton.bgColor}
              />
            ) : (
              <Ionicons
                name="mic"
                size={20}
                color={
                  recorder.isRecording ? '#FFFFFF' : theme.sendButton.bgColor
                }
              />
            )}
          </Pressable>
        ...
        >
          <TextInput
            ...
            placeholder={recorder.isRecording ? 'Gravando...' : placeholder}
