        ...
        >
          <View
            className="
                        ...
                        "
          >
            <Ionicons name="image-outline" size={42} color="#C34342" />
          </View>
      ...
      <View className="p-6 gap-6">
        <View className="gap-4">
          <View className="flex-row items-center justify-between">
            ...
            <View
              className="
                            ...
                            "
            >
              <Ionicons name="storefront-outline" size={28} color="#C34342" />
            </View>
          </View>
          ...
          <View className="flex-row flex-wrap gap-2">
            ...
            <View className="bg-primary/10 px-3 py-2 rounded-full">
              <Text className="text-primary text-xs font-semibold">Fotos</Text>
            </View>
