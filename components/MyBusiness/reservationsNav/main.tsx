...
export type ReservationSectionType = 'confirmadas' | 'aguardando' | 'calendario';
        ...
        <View className="flex-row gap-3 px-4 py-2">
            {SECTION_OPTIONS.map((section) => (
                <Pressable
                    ...
                    className={`flex-1 h-[30px] rounded-lg justify-center items-center ${activeSection === section.id
                            ? 'bg-primary'
                            : 'bg-secondary'
                        }`}
                    style={[
                ...
                >
                    <Text
                        className={`text-sm font-semibold ${activeSection === section.id
                                ? 'text-light'
                                : 'text-dark'
                            }`}
                    >
