...
const FILTER_OPTIONS: Array<{ id: ReviewFilterType; label: string }> = [
...
export const ReviewsFilterNav = ({
    ...
    const [activeFilter, setActiveFilter] = useState<ReviewFilterType>(initialFilter);
        ...
        <View className="flex-row gap-3">
            {FILTER_OPTIONS.map((filter) => (
                <Pressable
                    ...
                    className={`flex-1 h-10 rounded-lg justify-center items-center ${activeFilter === filter.id
                        ? 'bg-primary'
