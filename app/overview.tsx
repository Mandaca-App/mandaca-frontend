...
export default function Overview () {
    ...
    const story = 'Tudo começou na cozinha da nossa avó, onde o aroma de temperos frescos e o calor do fogão a lenha nos ensinaram sobre o amor em forma de comida. Nosso restaurante nasceu desse sonho: compartilhar os sabores da nossa infância'
