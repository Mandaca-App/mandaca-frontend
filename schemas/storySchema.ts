...
export const addressSchema = z.object({
    endereco: z
        ...
        .max(
            150,
            'O endereço deve ter no máximo 150 caracteres',
        ),
});
...
export const storySchema = z.object({
    historia: z
        ...
        .min(
            20,
            'A história deve ter no mínimo 20 caracteres',
        )
        .max(
            300,
            'A história deve ter no máximo 300 caracteres',
        ),
});
